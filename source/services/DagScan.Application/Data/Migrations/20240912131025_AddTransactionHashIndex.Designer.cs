...
namespace DagScan.Application.Data.Migrations
{
    ...
    [Migration("20240912131025_AddTransactionHashIndex")]
    partial class AddTransactionHashIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DagScan.Application.Domain.CurrencyPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CurrencyPrices", (string)null);
                });
            ...
            modelBuilder.Entity("DagScan.Application.Domain.HypergraphBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("HypergraphId"), new[] { "Balance", "WalletAddress" });

                    b.ToTable("HypergraphBalances", (string)null);
                });
            ...
            modelBuilder.Entity("DagScan.Application.Domain.HypergraphSnapshotMetric", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsTimeTriggered")
                        .HasColumnType("bit");
                    ...
                    b.Property<long>("TotalSnapshotCount")
                        .HasColumnType("bigint");

                    b.Property<long>("TotalSnapshotFeeAmount")
                        .HasColumnType("bigint");

                    b.Property<long>("TotalTransactionAmount")
                        .HasColumnType("bigint");

                    b.Property<long>("TotalTransactionCount")
                        .HasColumnType("bigint");

                    b.Property<long>("TotalTransactionFeeAmount")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.ToTable("HypergraphSnapshotMetrics", (string)null);
                });
            ...
            modelBuilder.Entity("DagScan.Application.Domain.MetagraphBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("MetagraphId"), new[] { "Balance", "MetagraphAddress", "WalletAddress" });

                    b.ToTable("MetagraphBalances", (string)null);
                });
            ...
            modelBuilder.Entity("DagScan.Application.Domain.WalletTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WalletTags", (string)null);
                });

            modelBuilder.Entity("DagScan.Application.Domain.HypergraphBalance", b =>
                {
                    b.HasOne("DagScan.Application.Domain.Hypergraph", null)
                        .WithMany("HypergraphBalances")
