...
import { getTransactions } from "@/lib/services/api-blockexplorer-requests";
import { SkeletonCard } from "@/components/ui/skeleton-card";
import { AlertCircle, Loader } from "lucide-react";
import { formatDate, formatMetagraphAmount } from "@/lib/utils";
import { Button } from "@/components/ui/button";

export function TransactionList({ metagraphId, metagraphSymbol }: { metagraphId?: string, metagraphSymbol?: string }) {
    ...
    const { data, isError, isFetching } = useQuery({
        queryKey: ['transactions', metagraphId, currentNext],
        queryFn: async () => {
            const result = await getTransactions(metagraphId, currentNext);
